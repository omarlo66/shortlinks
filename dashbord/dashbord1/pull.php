				...
				<section id="main" class="container medium">
					...
					<div class="box">
						...
						<div class="features-row">						
							...
							<section class="sahp">
			              <p>باي بال _ دولار امريكي</p><br>
			              <img src="../../images/17.jpg"><br><br>
			              <table class="tablepull">
			              	<tr>
			              		<td> الحد 10-2000 دولار امريكي</td>
			              		<td> المسؤل %-5 دولارات امريكية +0</td>
			              		<td> وقت المعالجة -1-2 ساعات</td>
			              		
			              	</tr>
			              </table>
			              <center>
									<div  id="code9" >
									<button type="submit"><a href=""> سحب الان</a></button>
								</div>
								</center>
						...
						<div class="features-row">						
			              ...
			              <center>
									<div  id="code9" >
									<button type="submit"><a href=""> ايداع الان</a></button>
								</div>
								</center>
